...
$lang = array_merge($lang, array(
	...
	'BROWSER_NOTIFICATION_MAX_BROWSERS_EXPLAIN' => 'O usuário não poderá ativar o Envio de Notificação para o fórum em qualquer navegador se a quantidade permitida de navegadores com Enviio de Notificações ativadas tiver sido alcançada. Digite 0 para desativar esta configuração <em>(não recomendado)</em>.',
